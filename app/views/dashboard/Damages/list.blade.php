...
@include('includes.Damages.addProduct')
     <!-- Page Content -->
    ...
    <div class="row">
          ...
          <!-- Nav tabs -->
            <ul class="nav nav-pills " role="tablist">
              <li class="active"><a href="#showDEntry" role="tab" data-toggle="tab"><h5><b><i>Damages Entry</i></b></h5></a></li>
              <li ><a href="#showDList" role="tab" data-toggle="tab"><h5><b><i>Damages List</i></b></h5></a></li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
              <div class="tab-pane active" id="showDEntry">
                 @include('includes.Damages.add')
              </div>
              <div class="tab-pane " id="showDList">
                 @include('includes.Damages.list')  
              </div>
            </div>
        </div>
    </div>
...
{{ HTML::script('_/js/damages.min.js')}}
@stop 